...
export const dashboardData = {
  water: {
    summary: [
      { label: '今日用水', value: '986.2', unit: 't' },
      { label: '实时流量', value: '42.8', unit: 'm³/h' },
      { label: '平均压力', value: '0.48', unit: 'MPa' },
      { label: '漏损率', value: '5.9', unit: '%' },
    ],
    districts: [
    ...
    alert: '二区压力接近高限',
    terminal: [
      { label: '管网健康', value: '95.0', unit: '%' },
      { label: '夜间基流', value: '18.4', unit: 'm³/h' },
      { label: '单位水耗', value: '2.81', unit: 't/万元' },
    ],
  ...
  power: {
    summary: [
      { label: '实时负荷', value: '85.6', unit: 'MW' },
      { label: '最大需量', value: '102.4', unit: 'MW' },
      { label: '功率因数', value: '0.96', unit: '' },
      { label: '频率', value: '50.03', unit: 'Hz' },
    ],
    transformers: [
      { name: '1#主变', load: '68.2', percent: 68.2, tone: 'normal' },
      { name: '2#主变', load: '92.1', percent: 92.1, tone: 'warning' },
      { name: '3#主变', load: '54.7', percent: 54.7, tone: 'normal' },
    ],
    tariffs: [
      { name: '尖时段', value: '785.0' },
      { name: '平时段', value: '456.0' },
      { name: '谷时段', value: '256.0' },
    ],
    quality: { label: 'THD', value: '2.8', unit: '%' },
    terminal: [
      { label: '供电可用率', value: '99.98', unit: '%' },
      { label: '在线电表', value: '64', unit: '/ 65' },
      { label: '需量利用率', value: '85.3', unit: '%' },
    ],
    load: '85.6',
  ...
  steam: {
    summary: [
      ...
      { label: '供汽压力', value: '1.60', unit: 'MPa' },
      { label: '供汽温度', value: '285', unit: '°C' },
    ],
    boilerStates: [
  ...
  bottomMetrics: [
    { icon: 'drop', label: '今日总用水', value: '986.2', unit: 't', trend: '↑ 3.2%', tone: 'cyan', detailKey: 'water', detailTitle: '水资源' },
    { icon: 'bolt', label: '今日总用电', value: '128.6', unit: 'MWh', trend: '↑ 4.5%', tone: 'yellow', detailKey: 'power', detailTitle: '电力资源' },
    { icon: 'heat', label: '今日总蒸汽', value: '326.4', unit: 't', trend: '↑ 2.8%', tone: 'orange', detailKey: 'steam', detailTitle: '蒸汽资源' },
    { icon: 'energy', label: '综合能耗', value: '82.6', unit: 'tce', trend: '↓ 2.1%', tone: 'cyan' },
    { icon: 'carbon', label: '碳排放', value: '68.2', unit: 'tCO₂', trend: '↓ 3.6%', tone: 'cyan' },
  ],
}
